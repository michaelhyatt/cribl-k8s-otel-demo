...
#variables
export CRIBL_STREAM_VERSION=4.13.3
export CRIBL_STREAM_WORKER_GROUP=otel-demo-k8s-wg
export CRIBL_STREAM_TOKEN=QexsmaRs6ys6gOr8xjMrq0dS9fmvRQZw
export CRIBL_STREAM_LEADER_URL=main-clever-faraday-3gqoers.cribl.cloud
export CRIBL_EDGE_VERSION=4.13.3
export CRIBL_EDGE_FLEET=otel-demo-k8s-fleet
export CRIBL_EDGE_LEADER_URL=main-clever-faraday-3gqoers.cribl.cloud
export CRIBL_EDGE_TOKEN=QexsmaRs6ys6gOr8xjMrq0dS9fmvRQZw
export NGROK_AUTHTOKEN=34BdwDolZx8OOGGMI7TToJ5rGUU_6H51LZ6K1FoRENC8vUvTQ
export NGROK_API_KEY=341G9EDNyxeutimzyAK9cdHIpRr_A3h3FSdq6WW4KA7FRczX
